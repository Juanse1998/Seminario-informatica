 ...
 * Demuestra el uso de SWING con JMenuBar y JTabbedPane
 */
public class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal(Inmobiliaria inmobiliaria, Usuario usuario) {
    ...
    private void inicializarComponentes() {
        ...
        panelPagos = new PanelPagos(panelContratos);
